const treinos = {
            ...
            5: [
                ...
                },
                {
                    ...
                    exercicios: [
                        ...
                        { nome: "Cadeira Extensora", series: "4x15 com drop-set na última", descanso: "45s", video: "https://www.youtube.com/results?search_query=Cadeira+Extensora" }
                    ]
                },
                 {
                    ...
                    exercicios: [
                        ...
                        { nome: "Crucifixo Invertido (Posterior)", series: "4x15", descanso: "45s", video: "https://www.youtube.com/results?search_query=Crucifixo+Invertido" },
            ...
            3: [
                ...
                },
                {
                    ...
                    exercicios: [
                        ...
                        { nome: "Rosca Martelo + Tríceps Francês", series: "3x15 (bi-set)", descanso: "60s", video: "https://www.youtube.com/results?search_query=Rosca+Martelo+Triceps+Frances" },
                ...
                },
                {
                ...
                },
                 {
                    ...
                    exercicios: [
                        ...
                        { nome: "Elevação Pélvica", series: "4x20", descanso: "30s", video: "https://www.youtube.com/results?search_query=Elevação+Pélvica" },
                        { nome: "HIIT no Remo (30s forte / 30s leve)", series: "10 min", descanso: "", video: "https://www.youtube.com/results?search_query=HIIT+Remo" }
                    ]
                },
                {
                    dia: "D - Superiores (Puxar) + Cardio Contínuo",
                    exercicios: [
                        { nome: "Barra Fixa (ou Puxador)", series: "5xMax", descanso: "90s", video: "https://www.youtube.com/results?search_query=Barra+Fixa" },
                        { nome: "Remada Curvada", series: "4x10", descanso: "60s", video: "https://www.youtube.com/results?search_query=Remada+Curvada" },
    ...
    feminino: {
            ...
            5: [
                ...
                },
                {
                    ...
                    exercicios: [
                        ...
                        { nome: "Elevação Pélvica", series: "4x15 com isometria no pico", descanso: "60s", video: "https://www.youtube.com/results?search_query=elevação+pélvica" },
                        { nome: "Mesa Flexora", series: "4x15", descanso: "45s", video: "https://www.youtube.com/results?search_query=mesa+flexora" },
        ...
        queima_gordura: {
            // Os treinos de queima de gordura são geralmente full body e unissex,
            // mas podemos fazer pequenos ajustes se necessário. Por agora, estão otimizados.
            2: [
                 {
                    dia: "Treino A - Full Body Circuito",
                    exercicios: [
                        { nome: "Agachamento com Salto", series: "3x20s", descanso: "40s", video: "https://www.youtube.com/results?search_query=Agachamento+com+Salto" },
                        { nome: "Remada com Elástico", series: "3x20", descanso: "40s", video: "https://www.youtube.com/results?search_query=Remada+com+Elastico" },
                        { nome: "Flexão de Braço (de joelhos se necessário)", series: "3xMax", descanso: "60s", video: "https://www.youtube.com/results?search_query=Flexao+de+Braco+joelhos" },
                ...
                },
                {
                    dia: "Treino B - Full Body HIIT",
                    exercicios: [
                        { nome: "Burpees (adaptado, sem salto se necessário)", series: "4x30s", descanso: "60s", video: "https://www.youtube.com/results?search_query=Burpees+iniciante" },
                        ...
                        { nome: "Corrida Estacionária (joelho alto)", series: "4x60s", descanso: "30s", video: "https://www.youtube.com/results?search_query=Corrida+Estacionaria" },
                        { nome: "Escalador", series: "4x45s", descanso: "30s", video: "https://www.youtube.com/results?search_query=Escalador" }
                    ]
                }
            ],
